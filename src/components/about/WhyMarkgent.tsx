    ...
    <section ref={sectionRef} id="why-markgent" className="bg-cream-soft py-20 md:py-28">
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="max-w-[780px]">
          ...
          <TextReveal as="h2" className="mt-4 text-[42px] leading-[1.08] text-ink sm:text-[54px] lg:text-[60px]">The depth of a specialist team, without the agency distance</TextReveal>
        </div>

        <div className="mt-14 grid overflow-hidden rounded-[28px] border border-line bg-paper shadow-[0_30px_65px_-38px_rgba(6,45,42,0.35)] lg:grid-cols-[1.02fr_0.98fr]">
          <div className="relative min-h-[430px] overflow-hidden lg:min-h-[660px]">
            ...
            {DIFFERENTIATORS.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`block w-full p-6 text-left outline-none transition-colors sm:p-8 ${isActive ? "bg-cream" : "bg-paper hover:bg-cream/50"}`}
                >
