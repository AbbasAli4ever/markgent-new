...
export const GradientPlane = ({
    ...
    // Built once. Colours are pushed imperatively in useFrame so the material
    // instance is never swapped out mid-animation.
    ...
    useFrame((state, delta) => {
        ...
        const { size } = state;
        // Accumulate delta rather than reading the clock, so a paused render
        // loop resumes where it left off instead of jumping ahead.
