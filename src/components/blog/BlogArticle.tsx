    ...
    <>
      <article>
        <header className="relative isolate overflow-hidden pb-16 pt-30 sm:pb-20 sm:pt-40 xl:pb-24 xl:pt-48">
          ...
          <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8 xl:px-10">
            ...
            <TextReveal as="h1" className="mt-4 max-w-[1000px] text-[40px] leading-[1.07] text-ink sm:text-[56px] md:text-[66px] xl:text-[72px]">{post.title}</TextReveal>
            <TextReveal as="p" delay={0.16} className="mt-6 max-w-[760px] text-[17px] leading-[1.7] text-body sm:text-xl">{post.excerpt}</TextReveal>
        ...
        <div className="mx-auto max-w-[800px] px-5 py-16 sm:px-8 sm:py-20 xl:py-24">
          {post.content.map((block, index) => {
            if (block.type === "heading") return <TextReveal key={index} as="h2" className="mb-5 mt-12 text-[29px] leading-[1.18] text-ink first:mt-0 sm:text-[36px]">{block.text}</TextReveal>;
            if (block.type === "paragraph") return <TextReveal key={index} as="p" className="my-6 text-[16px] leading-[1.85] text-body sm:text-[18px]">{block.text}</TextReveal>;
      ...
      <section aria-labelledby="related-heading" className="bg-cream-soft py-18 sm:py-22">
        <div className="mx-auto max-w-[1240px] px-5 sm:px-8 xl:px-10">
          ...
          <TextReveal as="h2" id="related-heading" className="mt-2 text-[34px] leading-[1.1] text-ink sm:text-[42px]">Related articles</TextReveal>
